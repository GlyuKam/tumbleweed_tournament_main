...
local Btn = Class(Widget, function(self, ll1l1ll1l1l11l1l11ll)
    Widget["_ctor"](self, "BtnReady") self:SetScale(1, 1) self["owner"] = ll1l1ll1l1l11l1l11ll for ll11l1l1l1l11l1l1ll1, l11l11l1ll11ll11l1ll in ipairs(ll1ll1l1l1l11l11ll11) do
    ...
    , self["owner"]) 
    self["inst"]:ListenForEvent("dirty_can_vote", function()
        self:Check()
    end
